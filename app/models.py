...
class AdminHomeData(Model):
  ...
  __table_args__ = (
    ...
    { 'mysql_engine':'InnoDB', 'mysql_charset':'utf8'  })
  admin_data_id = Column(
    INTEGER(unsigned=True),
    primary_key=True,
    nullable=False
  )
  admin_data_tag = Column(
    String(50),
    nullable=False
  )
  recent_finished_runs = Column(
    INTEGER,
    nullable=False
  )
  recent_finished_analysis = Column(
    INTEGER,
    nullable=False
  )
  ongoing_runs = Column(
...
class RawSeqrun(Model):
  ...
  __table_args__ = (
    ...
    { 'mysql_engine':'InnoDB', 'mysql_charset':'utf8'  })
  raw_seqrun_id =  Column(
    INTEGER(unsigned=True),
    primary_key=True,
    nullable=False
  )
  raw_seqrun_igf_id = Column(
    String(80),
    nullable=False
  )
  override_cycles = Column(
    String(30),
    nullable=True
  )
  status = Column(
...
class RawMgiSeqrun(Model):
  ...
  __table_args__ = (
    ...
    { 'mysql_engine':'InnoDB', 'mysql_charset':'utf8'  })
  raw_mgi_seqrun_id =  Column(
    INTEGER(unsigned=True),
    primary_key=True,
    nullable=False
  )
  raw_mgi_seqrun_igf_id = Column(
    String(80),
    nullable=False
  )
  status = Column(
...
class RawPipeline(Model):
  ...
  :param date_stamp: An optional timestamp column to record file creation or modification time,
...
class SampleIndex(AuditMixin, Model):
  ...
  avg_region_molarity = Column(
    String(10),
    nullable=True
  )
  avg_fragment_size = Column(
    INTEGER,
    nullable=True
  )
  project_index_id = Column(
...
class Project(Model):
  ...
  def project_info(self):
      ...
      return Markup(
        f'<a href="{url}">{self.project_igf_id}</a>'
      )
...
class Experiment(Model):
  ...
  :param library_strategy: An optional enum list to specify library strategy information,
                           default is UNKNOWN, allowed values are
  ...
  :param date_created: An optional timestamp column to record entry creation or modification time,
                       default current timestamp
...
class Experiment_attribute(Model):
  ...
  experiment_attribute_id = Column(
    INTEGER(unsigned=True),
    primary_key=True,
    nullable=False
  )
...
class Collection_attribute(Model):
  ...
  collection_attribute_id = Column(
    INTEGER(unsigned=True),
    primary_key=True,
    nullable=False
  )
...
class Cosmx_platform(Model):
  ...
  cosmx_platform_id = Column(
    INTEGER(unsigned=True),
    primary_key=True,
    nullable=False
  )
  cosmx_platform_igf_id = Column(
    String(20),
    nullable=False
  )
  cosmx_platform_name = Column(
    String(20),
    nullable=True
  )
  date_created = Column(
...
class Cosmx_run(Model):
  ...
  cosmx_run_igf_id = Column(
    String(200),
    nullable=False
  )
  cosmx_run_name = Column(
    String(100),
    nullable=True
  )
  project_id = Column(
...
class Cosmx_slide(Model):
  ...
  cosmx_platform_id = Column(
    INTEGER(unsigned=True),
    ForeignKey(
      'cosmx_platform.cosmx_platform_id',
      onupdate="CASCADE",
      ondelete="CASCADE"
    ),
    nullable=False
...
class Cosmx_fov_annotation(Model):
  ...
  cosmx_fov_annotation_id = Column(
    INTEGER(unsigned=True),
    primary_key=True,
    nullable=False
  )
...
class Cosmx_fov_rna_qc(Model):
  ...
  cosmx_fov = relationship('Cosmx_fov')
  mean_transcript_per_cell = Column(
    DECIMALType(10, 2),
    nullable=True
  )
  mean_unique_genes_per_cell = Column(
    DECIMALType(10, 2),
    nullable=True
  )
  number_non_empty_cells = Column(
    INTEGER(unsigned=True),
    nullable=True
  )
  pct_non_empty_cells = Column(
    DECIMALType(10, 2),
    nullable=True
  )
  percentile_90_transcript_per_cell = Column(
    DECIMALType(10, 2),
    nullable=True
  )
  percentile_10_transcript_per_cell = Column(
    DECIMALType(10, 2),
    nullable=True
  )
  mean_negprobe_counts_per_cell = Column(
    DECIMALType(10, 3),
    nullable=True
  )
...
class Cosmx_fov_protein_qc(Model):
  ...
  cosmx_fov_protein_qc_id = Column(
    INTEGER(unsigned=True),
    primary_key=True,
    nullable=False
  )
  ...
  cosmx_fov = relationship('Cosmx_fov')
  mean_fluorescence_intensity = Column(
    INTEGER,
    nullable=True
  )
  mean_unique_genes_per_cell = Column(
  ...
  percentile_10_fluorescence_intensity = Column(
    DECIMALType(10, 2),
    nullable=True
  )
  percentile_90_fluorescence_intensity = Column(
    DECIMALType(10, 2),
    nullable=True
  )
  fluorescence_intensity_mean_igg_control_intensity = Column(
    DECIMALType(10, 3),
    nullable=True
  )
...
class Cosmx_slide_attribute(Model):
  ...
  cosmx_slide_attribute_id = Column(
    INTEGER(unsigned=True),
    primary_key=True,
    nullable=False
  )
